...
void initPWM()
{
    ...
    GPIO_PORTB_DIR_R |= RED_BL_LED_MASK | NEW_BL_MASK | SLEEP_MASK;                       // make bit5 an output
    GPIO_PORTB_DR2R_R |= RED_BL_LED_MASK | NEW_BL_MASK | SLEEP_MASK;                      // set drive strength to 2mA
    GPIO_PORTB_DEN_R |= RED_BL_LED_MASK | NEW_BL_MASK | SLEEP_MASK;                       // enable digital
    GPIO_PORTB_AFSEL_R |= RED_BL_LED_MASK | NEW_BL_MASK;                     // select auxilary function
